...
pub struct DetailedClub {
  ...
  activity_types: Option<Vec<::models::ActivityType>>,
  /// The club's city.
  #[serde(rename = "city")]
  city: Option<String>,
...
impl DetailedClub {
  ...
  pub fn with_id(mut self, id: i64) -> DetailedClub {
    self.id = Some(id);
    self
  }
  ...
  pub fn set_activity_types(&mut self, activity_types: Vec<::models::ActivityType>) {
    self.activity_types = Some(activity_types);
  }

  pub fn with_activity_types(mut self, activity_types: Vec<::models::ActivityType>) -> DetailedClub {
    self.activity_types = Some(activity_types);
    self
  }

  pub fn activity_types(&self) -> Option<&Vec<::models::ActivityType>> {
    self.activity_types.as_ref()
  }

  pub fn reset_activity_types(&mut self) {
