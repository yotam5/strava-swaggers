...
impl DetailedActivity {
  ...
  pub fn with_id(mut self, id: i64) -> DetailedActivity {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_external_id(mut self, external_id: String) -> DetailedActivity {
    self.external_id = Some(external_id);
    self
  }
  ...
  pub fn with_upload_id(mut self, upload_id: i64) -> DetailedActivity {
    self.upload_id = Some(upload_id);
    self
  }
  ...
  pub fn with_athlete(mut self, athlete: ::models::MetaAthlete) -> DetailedActivity {
    self.athlete = Some(athlete);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> DetailedActivity {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_distance(mut self, distance: f32) -> DetailedActivity {
    self.distance = Some(distance);
    self
  }
  ...
  pub fn with_moving_time(mut self, moving_time: i32) -> DetailedActivity {
    self.moving_time = Some(moving_time);
    self
  }
  ...
  pub fn with_elapsed_time(mut self, elapsed_time: i32) -> DetailedActivity {
    self.elapsed_time = Some(elapsed_time);
    self
  }
  ...
  pub fn with_total_elevation_gain(mut self, total_elevation_gain: f32) -> DetailedActivity {
    self.total_elevation_gain = Some(total_elevation_gain);
    self
  }
  ...
  pub fn with_elev_high(mut self, elev_high: f32) -> DetailedActivity {
    self.elev_high = Some(elev_high);
    self
  }
  ...
  pub fn with_elev_low(mut self, elev_low: f32) -> DetailedActivity {
    self.elev_low = Some(elev_low);
    self
  }
  ...
  pub fn with__type(mut self, _type: ::models::ActivityType) -> DetailedActivity {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_sport_type(mut self, sport_type: ::models::SportType) -> DetailedActivity {
    self.sport_type = Some(sport_type);
    self
  }
  ...
  pub fn with_start_date(mut self, start_date: String) -> DetailedActivity {
    self.start_date = Some(start_date);
    self
  }
  ...
  pub fn with_start_date_local(mut self, start_date_local: String) -> DetailedActivity {
    self.start_date_local = Some(start_date_local);
    self
  }
  ...
  pub fn with_timezone(mut self, timezone: String) -> DetailedActivity {
    self.timezone = Some(timezone);
    self
  }
  ...
  pub fn with_start_latlng(mut self, start_latlng: ::models::LatLng) -> DetailedActivity {
    self.start_latlng = Some(start_latlng);
    self
  }
  ...
  pub fn with_end_latlng(mut self, end_latlng: ::models::LatLng) -> DetailedActivity {
    self.end_latlng = Some(end_latlng);
    self
  }
  ...
  pub fn with_achievement_count(mut self, achievement_count: i32) -> DetailedActivity {
    self.achievement_count = Some(achievement_count);
    self
  }
  ...
  pub fn with_kudos_count(mut self, kudos_count: i32) -> DetailedActivity {
    self.kudos_count = Some(kudos_count);
    self
  }
  ...
  pub fn with_comment_count(mut self, comment_count: i32) -> DetailedActivity {
    self.comment_count = Some(comment_count);
    self
  }
  ...
  pub fn with_athlete_count(mut self, athlete_count: i32) -> DetailedActivity {
    self.athlete_count = Some(athlete_count);
    self
  }
  ...
  pub fn with_photo_count(mut self, photo_count: i32) -> DetailedActivity {
    self.photo_count = Some(photo_count);
    self
  }
  ...
  pub fn with_total_photo_count(mut self, total_photo_count: i32) -> DetailedActivity {
    self.total_photo_count = Some(total_photo_count);
    self
  }
  ...
  pub fn with_map(mut self, map: ::models::PolylineMap) -> DetailedActivity {
    self.map = Some(map);
    self
  }
  ...
  pub fn with_trainer(mut self, trainer: bool) -> DetailedActivity {
    self.trainer = Some(trainer);
    self
  }
  ...
  pub fn with_commute(mut self, commute: bool) -> DetailedActivity {
    self.commute = Some(commute);
    self
  }
  ...
  pub fn with_manual(mut self, manual: bool) -> DetailedActivity {
    self.manual = Some(manual);
    self
  }
  ...
  pub fn with_private(mut self, private: bool) -> DetailedActivity {
    self.private = Some(private);
    self
  }
  ...
  pub fn with_flagged(mut self, flagged: bool) -> DetailedActivity {
    self.flagged = Some(flagged);
    self
  }
  ...
  pub fn with_workout_type(mut self, workout_type: i32) -> DetailedActivity {
    self.workout_type = Some(workout_type);
    self
  }
  ...
  pub fn with_upload_id_str(mut self, upload_id_str: String) -> DetailedActivity {
    self.upload_id_str = Some(upload_id_str);
    self
  }
  ...
  pub fn with_average_speed(mut self, average_speed: f32) -> DetailedActivity {
    self.average_speed = Some(average_speed);
    self
  }
  ...
  pub fn with_max_speed(mut self, max_speed: f32) -> DetailedActivity {
    self.max_speed = Some(max_speed);
    self
  }
  ...
  pub fn with_has_kudoed(mut self, has_kudoed: bool) -> DetailedActivity {
    self.has_kudoed = Some(has_kudoed);
    self
  }
  ...
  pub fn set_hide_from_home(&mut self, hide_from_home: bool) {
    self.hide_from_home = Some(hide_from_home);
  }

  pub fn with_hide_from_home(mut self, hide_from_home: bool) -> DetailedActivity {
    self.hide_from_home = Some(hide_from_home);
    self
  }

  pub fn hide_from_home(&self) -> Option<&bool> {
    self.hide_from_home.as_ref()
  }

  pub fn reset_hide_from_home(&mut self) {
    self.hide_from_home = None;
  }
  ...
  pub fn with_gear_id(mut self, gear_id: String) -> DetailedActivity {
    self.gear_id = Some(gear_id);
    self
  }
  ...
  pub fn with_kilojoules(mut self, kilojoules: f32) -> DetailedActivity {
    self.kilojoules = Some(kilojoules);
    self
  }
  ...
  pub fn with_average_watts(mut self, average_watts: f32) -> DetailedActivity {
    self.average_watts = Some(average_watts);
    self
  }
  ...
  pub fn with_device_watts(mut self, device_watts: bool) -> DetailedActivity {
    self.device_watts = Some(device_watts);
    self
  }
  ...
  pub fn with_max_watts(mut self, max_watts: i32) -> DetailedActivity {
    self.max_watts = Some(max_watts);
    self
  }
  ...
  pub fn with_weighted_average_watts(mut self, weighted_average_watts: i32) -> DetailedActivity {
    self.weighted_average_watts = Some(weighted_average_watts);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> DetailedActivity {
    self.description = Some(description);
    self
  }
  ...
  pub fn set_photos(&mut self, photos: ::models::PhotosSummary) {
    self.photos = Some(photos);
  }

  pub fn with_photos(mut self, photos: ::models::PhotosSummary) -> DetailedActivity {
    self.photos = Some(photos);
    self
  }

  pub fn photos(&self) -> Option<&::models::PhotosSummary> {
    self.photos.as_ref()
  }

  pub fn reset_photos(&mut self) {
    self.photos = None;
  }

  pub fn set_gear(&mut self, gear: ::models::SummaryGear) {
    self.gear = Some(gear);
  }

  pub fn with_gear(mut self, gear: ::models::SummaryGear) -> DetailedActivity {
    self.gear = Some(gear);
    self
  }

  pub fn gear(&self) -> Option<&::models::SummaryGear> {
    self.gear.as_ref()
  }
  ...
  pub fn set_calories(&mut self, calories: f32) {
    self.calories = Some(calories);
  }

  pub fn with_calories(mut self, calories: f32) -> DetailedActivity {
    self.calories = Some(calories);
    self
  }

  pub fn calories(&self) -> Option<&f32> {
    self.calories.as_ref()
  }

  pub fn reset_calories(&mut self) {
    self.calories = None;
  }

  pub fn set_segment_efforts(&mut self, segment_efforts: Vec<::models::DetailedSegmentEffort>) {
    self.segment_efforts = Some(segment_efforts);
  }

  pub fn with_segment_efforts(mut self, segment_efforts: Vec<::models::DetailedSegmentEffort>) -> DetailedActivity {
    self.segment_efforts = Some(segment_efforts);
    self
  }

  pub fn segment_efforts(&self) -> Option<&Vec<::models::DetailedSegmentEffort>> {
    self.segment_efforts.as_ref()
  }

  pub fn reset_segment_efforts(&mut self) {
    self.segment_efforts = None;
  }
  ...
  pub fn with_device_name(mut self, device_name: String) -> DetailedActivity {
    self.device_name = Some(device_name);
    self
  }
  ...
  pub fn reset_device_name(&mut self) {
    self.device_name = None;
  }

  pub fn set_embed_token(&mut self, embed_token: String) {
    self.embed_token = Some(embed_token);
  }

  pub fn with_embed_token(mut self, embed_token: String) -> DetailedActivity {
    self.embed_token = Some(embed_token);
    self
  }

  pub fn embed_token(&self) -> Option<&String> {
    self.embed_token.as_ref()
  }

  pub fn reset_embed_token(&mut self) {
    self.embed_token = None;
  }

  pub fn set_splits_metric(&mut self, splits_metric: Vec<::models::Split>) {
    self.splits_metric = Some(splits_metric);
  }

  pub fn with_splits_metric(mut self, splits_metric: Vec<::models::Split>) -> DetailedActivity {
    self.splits_metric = Some(splits_metric);
    self
  }

  pub fn splits_metric(&self) -> Option<&Vec<::models::Split>> {
    self.splits_metric.as_ref()
  }

  pub fn reset_splits_metric(&mut self) {
    self.splits_metric = None;
  }

  pub fn set_splits_standard(&mut self, splits_standard: Vec<::models::Split>) {
    self.splits_standard = Some(splits_standard);
  }

  pub fn with_splits_standard(mut self, splits_standard: Vec<::models::Split>) -> DetailedActivity {
    self.splits_standard = Some(splits_standard);
    self
  }

  pub fn splits_standard(&self) -> Option<&Vec<::models::Split>> {
    self.splits_standard.as_ref()
  }

  pub fn reset_splits_standard(&mut self) {
    self.splits_standard = None;
  }

  pub fn set_laps(&mut self, laps: Vec<::models::Lap>) {
    self.laps = Some(laps);
  }

  pub fn with_laps(mut self, laps: Vec<::models::Lap>) -> DetailedActivity {
    self.laps = Some(laps);
    self
  }

  pub fn laps(&self) -> Option<&Vec<::models::Lap>> {
    self.laps.as_ref()
  }
  ...
  pub fn set_best_efforts(&mut self, best_efforts: Vec<::models::DetailedSegmentEffort>) {
    self.best_efforts = Some(best_efforts);
  }

  pub fn with_best_efforts(mut self, best_efforts: Vec<::models::DetailedSegmentEffort>) -> DetailedActivity {
    self.best_efforts = Some(best_efforts);
    self
  }

  pub fn best_efforts(&self) -> Option<&Vec<::models::DetailedSegmentEffort>> {
    self.best_efforts.as_ref()
  }

  pub fn reset_best_efforts(&mut self) {
    self.best_efforts = None;
  }
