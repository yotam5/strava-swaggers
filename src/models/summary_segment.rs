...
impl SummarySegment {
  ...
  pub fn with_athlete_pr_effort(mut self, athlete_pr_effort: ::models::SummaryPrSegmentEffort) -> SummarySegment {
    self.athlete_pr_effort = Some(athlete_pr_effort);
    self
  }
  ...
  pub fn with_athlete_segment_stats(mut self, athlete_segment_stats: ::models::SummarySegmentEffort) -> SummarySegment {
    self.athlete_segment_stats = Some(athlete_segment_stats);
    self
  }
