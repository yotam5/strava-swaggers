...
pub struct DetailedSegment {
  ...
  athlete_pr_effort: Option<::models::SummaryPrSegmentEffort>,
  #[serde(rename = "athlete_segment_stats")]
  athlete_segment_stats: Option<::models::SummarySegmentEffort>,
...
impl DetailedSegment {
  ...
  pub fn set_athlete_pr_effort(&mut self, athlete_pr_effort: ::models::SummaryPrSegmentEffort) {
    self.athlete_pr_effort = Some(athlete_pr_effort);
  }

  pub fn with_athlete_pr_effort(mut self, athlete_pr_effort: ::models::SummaryPrSegmentEffort) -> DetailedSegment {
    self.athlete_pr_effort = Some(athlete_pr_effort);
    self
  }

  pub fn athlete_pr_effort(&self) -> Option<&::models::SummaryPrSegmentEffort> {
  ...
  pub fn set_athlete_segment_stats(&mut self, athlete_segment_stats: ::models::SummarySegmentEffort) {
    self.athlete_segment_stats = Some(athlete_segment_stats);
  }

  pub fn with_athlete_segment_stats(mut self, athlete_segment_stats: ::models::SummarySegmentEffort) -> DetailedSegment {
    self.athlete_segment_stats = Some(athlete_segment_stats);
    self
  }

  pub fn athlete_segment_stats(&self) -> Option<&::models::SummarySegmentEffort> {
    self.athlete_segment_stats.as_ref()
  }

  pub fn reset_athlete_segment_stats(&mut self) {
    self.athlete_segment_stats = None;
  }
