...
impl UpdatableActivity {
  ...
  pub fn with_hide_from_home(mut self, hide_from_home: bool) -> UpdatableActivity {
    self.hide_from_home = Some(hide_from_home);
    self
  }
  ...
  pub fn with_sport_type(mut self, sport_type: ::models::SportType) -> UpdatableActivity {
    self.sport_type = Some(sport_type);
    self
  }
