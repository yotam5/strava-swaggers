...
impl Route {
  ...
  pub fn with_id(mut self, id: i64) -> Route {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_id_str(mut self, id_str: String) -> Route {
    self.id_str = Some(id_str);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> Route {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> Route {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn set_estimated_moving_time(&mut self, estimated_moving_time: i32) {
    self.estimated_moving_time = Some(estimated_moving_time);
  }

  pub fn with_estimated_moving_time(mut self, estimated_moving_time: i32) -> Route {
    self.estimated_moving_time = Some(estimated_moving_time);
    self
  }

  pub fn estimated_moving_time(&self) -> Option<&i32> {
    self.estimated_moving_time.as_ref()
  }

  pub fn reset_estimated_moving_time(&mut self) {
    self.estimated_moving_time = None;
  }
  ...
  pub fn set_waypoints(&mut self, waypoints: Vec<::models::Waypoint>) {
    self.waypoints = Some(waypoints);
  }

  pub fn with_waypoints(mut self, waypoints: Vec<::models::Waypoint>) -> Route {
    self.waypoints = Some(waypoints);
    self
  }

  pub fn waypoints(&self) -> Option<&Vec<::models::Waypoint>> {
